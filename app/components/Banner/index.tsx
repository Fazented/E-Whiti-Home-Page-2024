            ...
            <div className="mx-auto max-w-7xl pt-20 sm:pb-24 px-6">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12'>
                    ...
                    <div className='col-span-7 flex flex-col justify-evenly relative'>
                        ...
                        <h1 className='text-midnightblue text-4xl md:text-85xl text-center lg:text-start font-semibold lh-133 pt-5'>What do i put here harry</h1>
                        <h3 className='text-black opacity-75 text-lg font-normal text-center lg:text-start pt-8'>Or here, i dont know know what to write here or what we are doing</h3>
